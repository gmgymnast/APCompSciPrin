def main(a, b, c, d, e, f, g, h): return prob1(a, b, c) + prob2(d, e, f) + prob3(g) + prob3(h)
...
print(main(int(input("Prob 1 Info 1: ")), int(input("Prob 1 Info 2: ")), int(input("Prob 1 Info 3: ")), \
